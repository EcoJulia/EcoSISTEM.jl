...
**Do not add an arbitrary example here.** Anything at this level must run, in reasonable time,
...
`other/` is a holding area, not an archive. Its contents are not compiled, not run, and will rot;
