...
for (i in seq_along(filenames)){
  ...
  writeRaster(rag, paste("/Users/claireh/Documents/PhD/GIT/ClimatePref.jl/data/wc/",
...
for (i in seq_along(filenames)){
  ...
  rag = aggregate(r, fact = 9)
  writeRaster(rag, paste("/Users/claireh/Documents/PhD/GIT/ClimatePref.jl/data/wc/wc2.0_5m_prec/",
                         filenames[i], sep=""), overwrite=T)
}