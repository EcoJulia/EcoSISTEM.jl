...
times = 10year;
div = runsim(times)
save("SantiniRun_reeve150_phylo.jld", "div", div)
div[isnan.(div)] = 0
...
png('Temp_trends_reeve_phylo.png', width = 1000, height = 900)
...
for (i in 1:7){
    ...
    png('barplot_reeve_phylo.png', width = 1200, height = 800)
    print(g)
    dev.off()
"
    ...
    g = ggplot(dat, aes(y= mn, x = scenario, fill = measure)) + geom_bar(stat = 'identity') +
        ...
        geom_errorbar(aes(ymin=lo, ymax=up),
                ...
                axis.text.x = element_text(size=12, angle = 45, vjust = 0.9, hjust = 1))+
                 geom_text(aes(y = adj, label=rep), size = 6)+
        scale_fill_manual(palette = colorRampPalette(brewer.pal(7, 'Paired')))
    png('Early_barplot_reeve_phylo.png', width = 1200, height = 800)
    print(g)
    dev.off()
"
    ...
    g = ggplot(dat, aes(y= mn, x = scenario, fill = measure)) + geom_bar(stat = 'identity') +
        ...
        geom_errorbar(aes(ymin=lo, ymax=up),
                ...
                axis.text.x = element_text(size=12, angle = 45, vjust = 0.9, hjust = 1))+
                 geom_text(aes(y = adj, label=rep), size = 6)+
        scale_fill_manual(palette = colorRampPalette(brewer.pal(7, 'Paired')))
    png('Raw_barplot_reeve_phylo.png', width = 1200, height = 800)
    print(g)
    dev.off()
"
# Check for early and late warning signals
    ...
    g = ggplot(dat, aes(y= mn, x = scenario, fill = measure)) + geom_bar(stat = 'identity') +
        ...
        geom_errorbar(aes(ymin=lo, ymax=up),
                ...
                axis.text.x = element_text(size=12, angle = 45, vjust = 0.9, hjust = 1))+
                 geom_text(aes(y = adj, label=rep), size = 6)+
        scale_fill_manual(palette = colorRampPalette(brewer.pal(7, 'Paired')))
    png('Early_raw_barplot_reeve_phylo.png', width = 1200, height = 800)
    print(g)
    dev.off()
"
