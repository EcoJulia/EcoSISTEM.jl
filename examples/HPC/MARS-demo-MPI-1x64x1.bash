...
#SBATCH --job-name=MPIRun-1x64x1  # some descriptive job name of your choice
...
############# MY CODE #############
bin/mpiexecjl --project=examples -n 64 julia -t 1 --project=examples examples/HPC/MPIRun.jl
