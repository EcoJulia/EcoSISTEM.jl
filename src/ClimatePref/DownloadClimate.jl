...
pathdict = (rain_max = "rain_max/ukv_daily_rain_max_",
            rain_mean = "rain_mean/ukv_daily_rain_mean_",
            rain_min = "rain_min/ukv_daily_rain_min_",
            temp_max = "t1o5m_max/ukv_daily_t1o5m_max_",
            temp_mean = "t1o5m_mean/ukv_daily_t1o5m_mean_",
            temp_min = "t1o5m_min/ukv_daily_t1o5m_min_",
            humidity_max = "sh_max/ukv_daily_sh_max_",
            humidity_mean = "sh_mean/ukv_daily_sh_mean_",
            humidity_min = "sh_min/ukv_daily_sh_min_",
            sunshine_max = "sw_max/ukv_daily_sw_max_",
            sunshine_mean = "sw_mean/ukv_daily_sw_mean_",
            sunshine_min = "sw_min/ukv_daily_sw_min_")
datadict = (uk_hourly = "metoffice_ukv_hourly/",
            uk_daily = "metoffice_ukv_daily/")
paramdict = (rain_max = "stratiform_rainfall_flux",
             rain_mean = "stratiform_rainfall_flux",
             rain_min = "stratiform_rainfall_flux",
             temp_max = "air_temperature", temp_mean = "air_temperature",
             temp_min = "air_temperature", humidity_max = "specific_humidity",
             humidity_mean = "specific_humidity",
             humidity_min = "specific_humidity", sunshine_max = "m01s01i202",
             sunshine_mean = "m01s01i202", sunshine_min = "m01s01i202")
...
"""
function MetOfficeDownload(dataset::Symbol, param::Symbol, outputfolder::String,
                           startDate::DateTime, endDate::DateTime;
                           read::Bool = true, process::Bool = true)
    ...
    if process
        return processMet(outputfolder, splitpath(endurl)[2], paramdict[param],
                          times)
    else
        return readMet_raw(outputfolder, splitpath(endurl)[2], paramdict[param],
                           times)
    end
end
