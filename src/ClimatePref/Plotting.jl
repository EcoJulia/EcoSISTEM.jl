...
"""
    getprofile(spp_names::Array{String, 1}, data::NextTable, variable_name::String, dims::Tuple{Int64, Int64} = (1,1))
...
"""
function getprofile(spp_names::Array{String, 1}, data::NextTable, var::Symbol, label::String, dims::Tuple{Int64, Int64} = (1,1))
