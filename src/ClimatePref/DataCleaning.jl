...
function downresolution(wc::Worldclim_monthly, rescale::Int64; fn::F = mean) where {F<:Function}
    array = downresolution(wc.array, rescale, fn)
    return Worldclim_monthly(array)
end
function downresolution(bc::Worldclim_bioclim, rescale::Int64; fn::F = mean) where {F<:Function}
