...
"""
    EpiList(traits::TR, virus_abun::Vector{Int64}, human_abun::Vector{Int64}, disease_classes::NamedTuple, movement::MO, param::P, age_categories::Int64 = 1) where {TR <: AbstractTraits, MO <: AbstractMovement, P <: AbstractParams}
