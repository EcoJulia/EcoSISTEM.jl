...
import EcoSISTEM: MPIGridLandscape, emptyMPIgridlandscape, synchronise_from_rows!, synchronise_from_cols!
...
function MPIGridLandscape(sppcounts::Vector{Int32}, sccounts::Vector{Int32},
  ...
  return MPIGridLandscape{typeof(reshaped_cols[1]), typeof(rows)}(rows_matrix,
                                                                  ...
                                                                  [MersenneTwister(rand(UInt)) for _ in Base.OneTo(Threads.nthreads())])
end
