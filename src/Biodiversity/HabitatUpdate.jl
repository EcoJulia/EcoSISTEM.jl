...
function _habitatupdate!(eco::Ecosystem, hab::HabitatCollection3,
                         timestep::Unitful.Time)
    _habitatupdate!(eco, hab.h1, timestep)
    _habitatupdate!(eco, hab.h2, timestep)
    return _habitatupdate!(eco, hab.h3, timestep)
end
...
function _budgetupdate!(eco::AbstractEcosystem, budget::VolWaterBudget,
                        timestep::Unitful.Time)
    return budget
end
...
function _budgetupdate!(eco::AbstractEcosystem, budget::BudgetCollection3,
                        timestep::Unitful.Time)
    _budgetupdate!(eco, eco.abenv.budget.b1, timestep)
    _budgetupdate!(eco, eco.abenv.budget.b2, timestep)
    return _budgetupdate!(eco, eco.abenv.budget.b3, timestep)
end
