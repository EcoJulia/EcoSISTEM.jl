...
@testset "Update functions" begin
    ...
    @test_nowarn EcoSISTEM.calc_lookup_moves!(eco.spplist.species.movement.boundary,
                                              1, 1, 1, eco, 10)
    @test typeof(EcoSISTEM.calc_lookup_moves!(eco.spplist.species.movement.boundary,
                                              1, 1, 1, eco,
                                              10)) == Vector{Int64}
