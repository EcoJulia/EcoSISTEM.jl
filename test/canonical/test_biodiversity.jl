...
@test all(endabuns[:, 1, 1] .> endabuns[:, 1, 2] .> endabuns[:, 1, 3] .> endabuns[:, 1, 4])
@test all(endabuns[:, end, 1] .> endabuns[:, end, 2] .> endabuns[:, end, 3] .> endabuns[:, end, 4])
@test all(endabuns[:, 5, 1] .< endabuns[:, 5, 2] .< endabuns[:, 5, 3] .< endabuns[:, 5, 4])
