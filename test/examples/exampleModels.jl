...
endabun = mapslices(sum, JLD2.load(joinpath(cachefolder, "cache/DiffOpts10001.jld2"), "abun"), dims = 2)[:,1]
...
endabun = mapslices(sum, JLD2.load(joinpath(cachefolder, "cache/DiffVars10001.jld2"), "abun"), dims = 2)[:,1]
...
endabun = mapslices(sum, JLD2.load(joinpath(cachefolder, "cache/DiffVarsMismatch10001.jld2"), "abun"), dims = 2)[:,1]
widths = map(eachindex(vars)) do i
    repeat([vars[i]], endabun[i])
end
widths = vcat(widths...)
...
endabun = mapslices(sum, JLD2.load(joinpath(cachefolder, "cache/Energy10001.jld2"), "abun"), dims = 1)[1,:]
...
endabun1 = sum(JLD2.load(joinpath(cachefolder, "cache/GridSize110001.jld2"), "abun"))
endabun2 = sum(JLD2.load(joinpath(cachefolder, "cache/GridSize210001.jld2"), "abun"))
endabun3 = sum(JLD2.load(joinpath(cachefolder, "cache/GridSize510001.jld2"), "abun"))
endabun4 = sum(JLD2.load(joinpath(cachefolder, "cache/GridSize1010001.jld2"), "abun"))
...
endabun1 = sum(JLD2.load(joinpath(cachefolder, "cache/Area1010001.jld2"), "abun"))
endabun2 = sum(JLD2.load(joinpath(cachefolder, "cache/Area2010001.jld2"), "abun"))
endabun3 = sum(JLD2.load(joinpath(cachefolder, "cache/Area5010001.jld2"), "abun"))
endabun4 = sum(JLD2.load(joinpath(cachefolder, "cache/Area10010001.jld2"), "abun"))
...
for i in 1:4
    endabun = mapslices(sum, JLD2.load(joinpath(cachefolder, "cache/Dispersal$i"*"10001.jld2"), "abun"), dims = 1)[1,:]
    endabun = reshape(endabun, 10, 10)
    m = distances[i]
