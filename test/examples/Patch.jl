...
numInvasive = 1; numSpecies = 100; grd = (10,10); req=(450000.0kJ/m^2, 192.0nm/m^2); individuals = 100_000_000; area = 100.0*km^2; totalK = (4.5e11kJ/km^2, 192.0mm/km^2)
...
simDict = Dict("times" => 50years, "burnin" => 10year, "interval" => 1month, "timestep" => 1month, "scenarios" => scenario, "divfuns" => divfuns, "q" => q, "reps" => 100, "scenario_names" => scenario_names, "cacheInterval" => 10years)
...
for i in 1:simDict["reps"]
    ...
    runsim!(diver, abenv, paramDict, simDict, i, "data/testcache/")
end
